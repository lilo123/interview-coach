          ...
          <div>
            ...
            {feedback && typeof feedback === 'object' && !Array.isArray(feedback) ? (
              ...
              <div className="mt-8 space-y-4 text-left opacity-50 grayscale pointer-events-none">
                ...
                <div className="p-4 bg-yellow-50 rounded-xl border border-yellow-200">
                  <h3 className="font-bold text-yellow-800 mb-2">🧹 Cleaned Transcript</h3>
                  <p className="text-sm text-gray-500 italic">AI will fix transcription errors but keep your natural speech patterns (um, ah, like)...</p>
                </div>
                <div className="p-4 bg-blue-50 rounded-xl border border-blue-200">
                  <h3 className="font-bold text-blue-800 mb-2">📊 Content & Structure</h3>
                  <p className="text-sm text-gray-500 italic">AI will evaluate if you actually answered the specific question asked and assess your structure...</p>
                </div>
                <div className="p-4 bg-purple-50 rounded-xl border border-purple-200">
                  <h3 className="font-bold text-purple-800 mb-2">🗣️ Tone & Executive Presence</h3>
